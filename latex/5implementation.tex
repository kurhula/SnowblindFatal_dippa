...
As the library I deemed most suitable for this project was Java-based and since there was no significant downsides to using Java, I used it as the language for the program.
